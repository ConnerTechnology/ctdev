...
onto what Linear already has. Both labels exist on the team (2026-09-18).
...
| `enhancement`             | Label `Feature` or `Improvement`                | New behavior, or a better version of existing behavior                                |
