...
var Registry = []Component{
	...
	{Name: "brain", Description: "ConnerTechnology/brain agent org + its scheduled runs (systemd)", Category: CategoryInfra, SupportedOS: []OS{OSLinux}, Dependencies: []string{"git"}, DetectPath: "/usr/local/bin/brain-run", Root: RootAlways, GoInstall: brainInstall, GoUninstall: brainUninstall, Tags: []string{"ai", "claude", "agents", "homelab"}},
	...
	{Name: "mcp-email-server", Description: "MCP server exposing your mailboxes over IMAP (Docker)", Category: CategoryInfra, SupportedOS: []OS{OSLinux}, Dependencies: []string{"docker"}, DetectPath: "$HOME/mcp-email-server/docker-compose.yml", Root: RootNever, GoInstall: mcpEmailServerInstall, GoUninstall: mcpEmailServerUninstall, Tags: []string{"mcp", "email", "ai", "homelab"}},
	...
	{Name: "tradingview", Description: "TradingView desktop charts", Category: CategoryDesktop, SupportedOS: []OS{OSAny}, DetectCmd: "tradingview", DetectApps: []string{"/Applications/TradingView.app"}, GoInstall: tradingviewInstall, GoUninstall: tradingviewUninstall, Tags: []string{"trading", "charts", "finance"}},
