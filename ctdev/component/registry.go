...
var Registry = []Component{
	...
	{Name: "fonts", Description: "Nerd Fonts for terminal", Category: CategoryRuntime, SupportedOS: []OS{OSAny}, DetectPath: "$HOME/.local/share/fonts/FiraCodeNerdFont-Bold.ttf", DetectApps: []string{"$HOME/Library/Fonts/FiraCodeNerdFont-Bold.ttf"}, GoInstall: fontsInstall, GoUninstall: fontsUninstall, Tags: []string{"nerd", "terminal"}},
