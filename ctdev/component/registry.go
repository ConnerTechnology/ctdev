...
var Registry = []Component{
	...
	{Name: "chrome", Description: "Google Chrome browser", Category: CategoryDesktop, SupportedOS: []OS{OSAny}, DetectCmd: "google-chrome", GoInstall: chromeInstall, GoUninstall: chromeUninstall, Tags: []string{"browser", "web"}},
	...
	{Name: "dbeaver", Description: "DBeaver database tool", Category: CategoryDesktop, SupportedOS: []OS{OSAny}, GoInstall: dbeaverInstall, GoUninstall: dbeaverUninstall, Tags: []string{"database", "sql"}},
	{Name: "docker", Description: "Docker container runtime", Category: CategoryCLI, SupportedOS: []OS{OSAny}, GoInstall: dockerInstall, GoUninstall: dockerUninstall, Tags: []string{"container", "devops"}},
	...
	{Name: "fonts", Description: "Nerd Fonts for terminal", Category: CategoryRuntime, SupportedOS: []OS{OSAny}, DetectPath: "$HOME/.local/share/fonts/FiraCodeNerdFont-Bold.ttf", GoInstall: fontsInstall, GoUninstall: fontsUninstall, Tags: []string{"nerd", "terminal"}},
	...
	{Name: "ghostty", Description: "Ghostty terminal emulator", Category: CategoryDesktop, SupportedOS: []OS{OSAny}, GoInstall: ghosttyInstall, GoUninstall: ghosttyUninstall, Tags: []string{"terminal", "emulator"}},
